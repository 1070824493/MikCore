...
public struct LKCustomButtonConfig {
    ...
    public var backgroundImage: UIImage? = UIImage.lk.image(UIColor.lk.color(.hexFFFFFF))
    
    /// background image for highlight
    public var highlightBackgroundImage: UIImage? = UIImage.lk.image(UIColor.lk.color(.hex1B1B1B, alpha: 0.07))
        
    /// background image for disabled
    public var disabledBackgroundImage: UIImage? = UIImage.lk.image(UIColor.lk.color(.hexCDCDCD))
    ...
    public var titleColor: UIColor = UIColor.lk.color(.hex1B1B1B)
    
    /// title color for highlight
    public var highlightTitleColor: UIColor = UIColor.lk.color(.hex1B1B1B)
...
fileprivate extension LKButton.Style {
    ...
    var config: LKCustomButtonConfig {
        ...
        case .fillRed:
            ...
            config.highlightBackgroundImage = UIImage.lk.image(UIColor.lk.color(.hexB01A27))
        ...
        case .borderRed:
            var config = LKCustomButtonConfig()
            config.backgroundImage = UIImage.lk.image(UIColor.lk.color(.hexFFFFFF))
            config.highlightBackgroundImage = UIImage.lk.image(UIColor.lk.color(.hexFEF1EF))
            config.titleColor = UIColor.lk.color(.hexCF1F2E)
            config.highlightTitleColor = UIColor.lk.color(.hexCF1F2E)
