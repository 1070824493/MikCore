...
class DefaultSegmentedView: JXSegmentedView {
    ...
    private lazy var titleDataSource: JXSegmentedTitleDataSource = {
        ...
        aTitleDataSource.titleNormalFont = UIFont.mik.font(.nunitoSansBold, size: 14)
        aTitleDataSource.titleSelectedFont = UIFont.mik.font(.nunitoSansBold, size: 14)
        aTitleDataSource.titleNormalColor = UIColor.mik.text(.hex1B1B1B)
        aTitleDataSource.titleSelectedColor = UIColor.mik.text(.hexCF1F2E)
...
extension DefaultSegmentedView {
    ...
    private func configure() {
        ...
        indicators = [MikSegmentedIndicatorLineView(indicatorSize: self.config.indicatorSize)]
...
// MARK: - MikSegmentedIndicatorLineView
fileprivate class MikSegmentedIndicatorLineView: JXSegmentedIndicatorLineView {
    
    required init(indicatorSize: CGSize? = nil) {
        super.init(frame: .zero)
        backgroundColor = UIColor.mik.general(.hexCF1F2E)
