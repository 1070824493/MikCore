...
class MikMessageHUDView: MikBaseHUDView {
    
    override var style: MikToast.MikHUDStyle {
        didSet {
    ...
    private lazy var contentView: UIView = {
        let aView = UIView()
        aView.backgroundColor = UIColor.mik.general(.hexFFFFFF, alpha: 0.9)
