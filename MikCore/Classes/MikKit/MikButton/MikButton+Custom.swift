...
public struct MikCustomButtonConfig {
    ...
    public var disabledBackgroundImage: UIImage? = UIImage.mik.image(UIColor.mik.general(.hex1B1B1B, alpha: 0.07))
    ...
    public var disabledTitleColor: UIColor = UIColor.mik.general(.hex1B1B1B)
