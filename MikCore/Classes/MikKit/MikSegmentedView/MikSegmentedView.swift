...
public protocol MikSegmentedDelegate: AnyObject {
...
open class MikSegmentedView: UIView {
    ...
    weak public var delegate: MikSegmentedDelegate?
    
    private let style: Style
    private let defaultSelectedIndex: Int
    private let listContainerView: MikListContainerView
    
    private lazy var segmentedView: JXSegmentedView = createSetgmentedView(style: style)
    
    required public init(style: Style, defaultSelectedIndex: Int = 0, listContrainer: MikListContainerView) {
        self.style = style
...
// MARK: - Public
public extension MikSegmentedView {
