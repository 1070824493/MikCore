...
extension MikGuideView {
    public static func show(fromView: UIView, cornerType: GuideCornerType = .allCorners, cornerRadius: CGFloat = 4.rate, title: NSAttributedString?, content: NSAttributedString?) {
        let guideView = MikGuideView.init(fromView, cornerType, cornerRadius, title, content)
        guideView.alpha = 0
        
        UIApplication.shared.mik.legacyKeyWindow?.addSubview(guideView)
    ...
    public static func showAndReturn(fromView: UIView, cornerType: GuideCornerType = .allCorners, cornerRadius: CGFloat = 4.rate, title: NSAttributedString?, content: NSAttributedString?) -> MikGuideView {
        let guideView = MikGuideView.init(fromView, cornerType, cornerRadius, title, content)
        guideView.alpha = 0
