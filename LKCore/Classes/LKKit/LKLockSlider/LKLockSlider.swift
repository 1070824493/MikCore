...
//MARK: - Class defines
public class LKLockSlider: UIControl {
    ...
    private lazy var thumbImageView: UIImageView = {
        let imageView = UIImageView(image: UIImage.image("lk_component_lock_slider_thumb"))
...
extension LKLockSlider {
    ...
    public struct ThumbImageViewConfigure {
        ...
        public init(backgroundColor: UIColor? = UIColor(red: 207/255.0, green: 31/255.0, blue: 46/255.0, alpha: 1),
                    image: UIImage? = UIImage.image("lk_component_lock_slider_thumb"),
        ...
        public static let `default` = ThumbImageViewConfigure(backgroundColor: UIColor(red: 207/255.0, green: 31/255.0, blue: 46/255.0, alpha: 1),
                                                              image: UIImage.image("lk_component_lock_slider_thumb"),
