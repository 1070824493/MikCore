...
public extension LKNameSpace where Base: UIView {
    ...
    /// 添加圆角的阴影效果
    func setShadowWithCorners(size: CGSize, roundingCorners: UIRectCorner = [.allCorners], cornerRadius: CGFloat = 8.rate, shadowColor: UIColor = UIColor.lk.hex(0x000000, alpha: 0.2), shadowOpacity: Float = 1, shadowOffset: CGSize = CGSize(width: 0, height: 1), shadowRadius: CGFloat = 6.0) {
        // 阴影的Path
