...
public class MikStarsView: UIControl {
    ...
    public struct Config {
        public var maximumImage: UIImage? = UIImage.image("mik_littlestar_n")
        public var minimumImage: UIImage? = UIImage.image("mik_littlestar_s")
        public var maximumTincolor: UIColor = UIColor.mik.general(.hexCDCDCD)
        public var minimumTincolor: UIColor = UIColor.mik.general(.hexEBAB33)
