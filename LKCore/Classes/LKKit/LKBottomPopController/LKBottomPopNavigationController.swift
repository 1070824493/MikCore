//
//  LKBottomPopNavigationController.swift
//  LKMobile
//
...
open class LKBottomPopNavigationController: LKNavigationController, BottomPopupAttributesDelegate {
...
extension LKBottomPopNavigationController {
    
    private func createTitleLab() -> UILabel {
        let label = UILabel()
        label.font = UIFont.lk.font(.IBMPlexSerifBold, size: 16.rate)
...
extension LKBottomPopNavigationController {
    ...
    public func addRightBarButtonItem(title: String?, font: UIFont = UIFont.lk.font(.nunitoSansBold, size: 14.rate), textColor: UIColor = UIColor.lk.text(.hex0475BC), image: UIImage?) {
