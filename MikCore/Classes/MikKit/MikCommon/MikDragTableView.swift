...
public protocol MikDragTableProtocol: NSObjectProtocol {
    
    /// 拖拽位置切换
    /// - Parameters:
    ///   - fromIndexPath: 从某位置
    ///   - toIndexPath: 切换到某位置
    func dragToExchange(_ tableView: MikDragTableView, fromIndexPath: IndexPath, toIndexPath: IndexPath) -> Void
}

public class MikDragTableView: UITableView {
    
    /// 拖拽代理
    public weak var dragProtocol: MikDragTableProtocol?
...
public extension MikDragTableView {
    // T：泛型，起到占位符的作用
