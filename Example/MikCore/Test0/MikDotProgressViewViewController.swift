//
//  MikDotProgressViewViewController.swift
//  MikCore
//
...
class MikDotProgressViewViewController: MikBaseViewController {
    ...
    private lazy var dotProgressView: MikDotProgressView = MikDotProgressView(titles: titles)
//    private lazy var dotProgressView: MikDotProgressView = MikDotProgressView(totalStep: titles.count)
