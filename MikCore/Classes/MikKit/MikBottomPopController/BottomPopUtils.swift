...
public struct BottomPopConstants {
    static let kDefaultHeight: CGFloat = UIScreen.mik.height - UIViewController.mik.safeAreaMin.top
    ...
    static let defaultPopupViewAccessibilityIdentifier: String = "com.mik.bottomPopupView"
}
