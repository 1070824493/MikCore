...
public class MikStarRateView: UIView {
    ...
    public required init(numberOfStars: Int = 5, currentStarCount: Int = 0, normalStarImageName: String = "mik_littlestar_n", selectedStarImageName: String = "mik_littlestar_s") {
