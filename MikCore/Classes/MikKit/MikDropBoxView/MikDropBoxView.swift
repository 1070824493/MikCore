...
public class MikDropBoxView: UIView {
    ...
    private var leftLabel: UILabel = {
        let item = UILabel()
        item.font = UIFont.mik.font(.nunitoSansBold, size: 30.rate)
    ...
    private var rightLabel: UILabel = {
        let item = UILabel()
        item.font = UIFont.mik.font(.nunitoSansBold, size: 14.rate)
        item.textColor = UIColor.mik.text(.hex1B1B1B)
    ...
    private lazy var tableView: UITableView = {
        ...
        tableView.backgroundColor = UIColor.mik.general(.hexF6F6F6)
...
extension MikDropBoxView: UITableViewDelegate, UITableViewDataSource {
