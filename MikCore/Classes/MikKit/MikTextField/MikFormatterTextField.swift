...
public extension Reactive where Base: MikFormatterTextField {
...
open class MikFormatterTextField: UITextField {
...
// MARK: - Assistant
fileprivate extension MikFormatterTextField {
