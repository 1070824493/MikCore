...
public extension LKNameSpace where Base: UIApplication {
    ...
    /// 当前控制器
    static func currentViewController(base: UIViewController? = UIApplication.shared.lk.legacyKeyWindow?.rootViewController) -> UIViewController? {
    ...
    /// 当前导航控制器
    static func currentNavigationController(base: UIViewController? = UIApplication.shared.lk.legacyKeyWindow?.rootViewController) -> UINavigationController? {
