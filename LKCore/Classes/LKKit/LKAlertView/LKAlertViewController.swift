...
open class LKAlertViewController: UIViewController {
...
// MARK: - Assistant
extension LKAlertViewController {
...
// MAKR: - Public meds
public extension LKAlertViewController {
    
    static func alertView(_ view: UIView) -> LKAlertViewController {
        return LKAlertViewController(view: view)
    }
