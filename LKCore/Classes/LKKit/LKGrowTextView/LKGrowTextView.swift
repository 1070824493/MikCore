...
public class LKGrowTextView: UITextView {
    ...
    private var placeholderTextAttributes: [NSAttributedString.Key: Any] {
        ...
        return [.paragraphStyle: paragraphStyle, .font: font ?? UIFont.lk.font(size: 16), .foregroundColor: placeholderColor ?? .lightGray]
    }
...
// MARK: - Public meds
public extension LKGrowTextView {
