...
fileprivate extension MikNameSpace where Base == NumberFormatter {
...
public extension MikNameSpace where Base == NumberFormatter {
...
public extension BinaryFloatingPoint {
    ...
    func asUnitNumber(minimumFractionDigits: Int = 2, maximumFractionDigits: Int = 2) -> String? {
        ...
        NumberFormatter.mik.numberFormatter.numberStyle = .decimal
        NumberFormatter.mik.numberFormatter.roundingMode = .halfUp
        NumberFormatter.mik.numberFormatter.minimumFractionDigits = fractionDigitsTuple.min
        NumberFormatter.mik.numberFormatter.maximumFractionDigits = fractionDigitsTuple.max
        let value = NumberFormatter.mik.numberFormatter.string(for: NSDecimalNumber(string: "\(unitTuple.value)"))
    ...
    func asCurrencyNumber(currencyCode: String = "USD", minimumFractionDigits: Int = 2, maximumFractionDigits: Int = 2) -> String? {
        NumberFormatter.mik.numberFormatter.numberStyle = .currency
        NumberFormatter.mik.numberFormatter.currencyCode = currencyCode
        NumberFormatter.mik.numberFormatter.roundingMode = .halfUp
        NumberFormatter.mik.numberFormatter.minimumFractionDigits = minimumFractionDigits
        NumberFormatter.mik.numberFormatter.maximumFractionDigits = maximumFractionDigits
        return NumberFormatter.mik.numberFormatter.string(for: NSDecimalNumber(string: "\(self)"))
    }
    ...
    func asDistanceNumber(minimumFractionDigits: Int = 1, maximumFractionDigits: Int = 1) -> String? {
        ...
        NumberFormatter.mik.numberFormatter.minimumFractionDigits = minimumFractionDigits
        NumberFormatter.mik.numberFormatter.maximumFractionDigits = maximumFractionDigits
        let value = NumberFormatter.mik.numberFormatter.string(for: NSDecimalNumber(string: "\(self)"))
