...
// LKOmitTextView.configure(isOpen: false, text: "the\n\n\n")
...
fileprivate class LinkTextView: UITextView {
    ...
    override func gestureRecognizerShouldBegin(_ gestureRecognizer: UIGestureRecognizer) -> Bool {
        if gestureRecognizer.view is Self {
...
public class LKOmitTextView: UIView {
...
extension LKOmitTextView: UITextViewDelegate {
