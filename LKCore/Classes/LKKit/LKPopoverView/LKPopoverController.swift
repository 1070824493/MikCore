...
open class LKPopoverController: UIViewController {
...
// MARK: - Private Meds
private extension LKPopoverController {
...
// MARK: - Public Meds
public extension LKPopoverController {
...
fileprivate class PCView: UIView {
    ...
    public var direction: LKPopoverController.PopoverDirection!
    public var convertFrame: CGRect!

    private let config: LKPopoverController.Config
    
    required init(frame: CGRect, config: LKPopoverController.Config) {
        self.config = config
