...
// MARK: - Public meds
public extension LKInputAlertView {
    
    typealias InputViewsTuple = (controller: LKAlertViewController, inputView: LKInputAlertView)
    
    static func inputAlertView(title: String?,
                               message: String?,
                               placeholder: String? = nil,
                               showInView viewController: UIViewController,
                               actions: [LKAlertAction]) -> InputViewsTuple {
        let inputAlertView = LKInputAlertView(title: title, message: message, placeholder: placeholder, actions: actions)        
        inputAlertView.selectBlock = { (action) in
            action.handle?()
        }

        let alertViewController = LKAlertViewController(view: inputAlertView)
...
public class LKInputAlertView: UIView {
    ...
    private var actions: [LKAlertAction]!
